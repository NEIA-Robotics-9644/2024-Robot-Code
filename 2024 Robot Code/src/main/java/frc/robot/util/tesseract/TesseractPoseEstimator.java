/*
 * robot pose estimation util
 * Utilizes odometry, vision, encoder data, subsystem output
 */

package frc.robot.util.tesseract;
...
public class TesseractPoseEstimator {
  ...
  public TesseractPoseEstimator(Matrix<N3, N1> stateStdDevs) {
    for (int i = 0; i < 3; ++i) {
